...
#
    SVM = '/export/b15/afavaro/Frontiers/submission/Classification_With_Feats_Selection/Cross_Val_Results_2/ENGLISH/All_Tasks/SVM/'
#
...
#
   ...
   # model = KNeighborsClassifier(metric='manhattan', n_neighbors= 15, weights= 'uniform')
    ...
    SVM = '/export/b15/afavaro/Frontiers/submission/Classification_With_Feats_Selection/Cross_Val_Results_2/ENGLISH/All_Tasks/KNN/'
    f_1 = report['1']['f1-score']
    acc = report['accuracy']
   ...
   # model = RandomForestClassifier(max_features='sqrt', n_estimators=100)
    ...
    SVM = '/export/b15/afavaro/Frontiers/submission/Classification_With_Feats_Selection/Cross_Val_Results_2/ENGLISH/All_Tasks/RF/'
    f_1 = report['1']['f1-score']
    acc = report['accuracy']
   ...
   # model = GradientBoostingClassifier(learning_rate= 0.001, max_depth= 9, n_estimators=1000, subsample= 0.7)
    ...
    SVM = '/export/b15/afavaro/Frontiers/submission/Classification_With_Feats_Selection/Cross_Val_Results_2/ENGLISH/All_Tasks/XG/'
    ...
    SVM = '/export/b15/afavaro/Frontiers/submission/Classification_With_Feats_Selection/Cross_Val_Results_2/ENGLISH/All_Tasks/BAGG/'
