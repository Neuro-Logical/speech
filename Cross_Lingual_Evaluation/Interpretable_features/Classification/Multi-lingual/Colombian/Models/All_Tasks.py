...
#spain = pd.read_csv("/export/b15/afavaro/Frontiers/submission/Statistical_Analysis/GITA/total_data_frame_novel_task_combined.csv") #first trial
...
for i in range(1, 11):
   ...
   # model = SVC(C=1.0, gamma=0.01, kernel='rbf')
    ...
    SVM = '/export/b15/afavaro/Frontiers/submission/Classification_With_Feats_Selection/Cross_Val_Results_2/GITA/All_Tasks/SVM/'
...
#
   ...
   # model = KNeighborsClassifier(metric='minkowski', n_neighbors= 17, weights= 'distance')
    ...
    SVM = '/export/b15/afavaro/Frontiers/submission/Classification_With_Feats_Selection/Cross_Val_Results_2/GITA/All_Tasks/KNN/'
    f_1 = report['1']['f1-score']
    acc = report['accuracy']
   ...
   # model = RandomForestClassifier(max_features= 'sqrt', n_estimators= 10)
    ...
    SVM = '/export/b15/afavaro/Frontiers/submission/Classification_With_Feats_Selection/Cross_Val_Results_2/GITA/All_Tasks/RF/'
    f_1 = report['1']['f1-score']
    acc = report['accuracy']
   ...
   # model = GradientBoostingClassifier(learning_rate=0.001, max_depth=3, n_estimators=1000, subsample=1.0)
    ...
    SVM = '/export/b15/afavaro/Frontiers/submission/Classification_With_Feats_Selection/Cross_Val_Results_2/GITA/All_Tasks/XG/'
    ...
    SVM = '/export/b15/afavaro/Frontiers/submission/Classification_With_Feats_Selection/Cross_Val_Results_2/GITA/All_Tasks/BAGG/'
