...
OUT_PATH ='/export/b15/afavaro/Frontiers/submission/Classification_With_Feats_Selection/Cross_Val_Results_Multi/GERMAN/TDU/AUROC/'
...
for i in range(1, 11):
   ...
   # model = SVC(C=0.01, gamma=0.1, kernel='poly',  probability=True)
