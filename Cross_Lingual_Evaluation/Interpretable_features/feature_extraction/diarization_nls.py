OUT_PATH = '/scratch4/lmorove1/afavaro/nls_experiments/all_audio_not_refined/out_diarization_all/'
...
one = '/scratch4/lmorove1/afavaro/nls_experiments/all_audio_not_refined/all_audio_not_refined/'
