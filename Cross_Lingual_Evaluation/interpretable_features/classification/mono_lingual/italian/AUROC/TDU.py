...
OUT_PATH = '/export/b15/afavaro/Frontiers/submission/Classification_With_Feats_Selection/Cross_Val_Results_2/ITALIAN/TDU/AUROC/'
...
for i in range(1, 11):
    ...
    model = SVC(C=10, gamma= 0.001, kernel= 'sigmoid', probability=True)
